...
Now you should have GD with Geode installed, this is probably enough for most players, you can now install all the mods you want however if you want to use CBF with the wine workaround proceed onto the [next step.](cbf)
